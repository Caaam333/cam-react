      ...
      <div className="cards">
            ...
            <div className="card">
              ...
              <div className="card-content">
                ...
                <p>
                  ...
                  <br />
                  {/* <u>TEMPS</u> */}
                  <img src="./assets/images/temps.png" className="picto" />1 semaine
                  <br />
        ...
        <div className="pets">
          <a href="https://www.placeforpets.xyz/" target="_blank">
            <div className="card">
              <img src="./assets/images/PLACE_FOR_PETS_v2.png" className="visuel" />
              <div className="card-content">
                <div className="card-title">
                ...
                <p>
                  ...
                  <br />
                  <img src="./assets/images/temps.png" className="picto" />3 semaines
                  <br />
            ...
            <div className="card">
              ...
              <div className="card-content">
                ...
                <p>
                  ...
                  <br />
                  <img src="./assets/images/temps.png" className="picto" />1 semaines
                  <br />
